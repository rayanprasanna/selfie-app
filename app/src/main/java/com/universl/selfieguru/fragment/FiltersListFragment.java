package com.universl.selfieguru.fragment;
...
import com.universl.selfieguru.adapter.ThumbnailsAdapter;
import com.universl.selfieguru.sub_activity.SelfieFilterActivity;
import com.universl.selfieguru.utils.BitmapUtils;
import com.universl.selfieguru.utils.SpacesItemDecoration;
    ...
    public void prepareThumbnail(final Bitmap bitmap) {
        Runnable r = new Runnable() {
            ...
            public void run() {
                ...
                if (bitmap == null) {
                    thumbImage = BitmapUtils.getBitmapFromAssets(Objects.requireNonNull(getActivity()), SelfieFilterActivity.IMAGE_NAME, 100, 100);
                } else {
