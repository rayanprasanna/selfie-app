...
public class EditorChoiceAdapter extends BaseAdapter {
    ...
    public EditorChoiceAdapter(Context context, List<SelfieResponse> selfieResponses, List<SelfieResponse> image_selfieResponses, ArrayList<String> image_pathList) {
